...
import org.vaadin.test.webinar.samples.backend.data.Availability;
...
public class ProductForm extends ProductFormDesign {
    ...
    public ProductForm(SampleCrudLogic sampleCrudLogic) {
        ...
        delete.addClickListener(new ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                ...
                System.out.println("Product "+product.getProductName()+" deleted.");
            }
        });
    }
    ...
    public void editProduct(Product product) {
        ...
        System.out.println("Product: "+product.getProductName()+" in editing");
