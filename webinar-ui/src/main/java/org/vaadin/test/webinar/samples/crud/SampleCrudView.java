package org.vaadin.test.webinar.samples.crud;

import java.util.Collection;

import org.vaadin.test.webinar.samples.ResetButtonForTextField;
import org.vaadin.test.webinar.samples.backend.DataService;
...
public class SampleCrudView extends CssLayout implements View {
    ...
    public HorizontalLayout createTopBar() {
        ...
        filter.setId("crud-filterfield");
        filter.addTextChangeListener(new FieldEvents.TextChangeListener() {
            @Override
            public void textChange(FieldEvents.TextChangeEvent event) {
            	System.out.println("Filtered with: "+event.getText());
        ...
        newProduct.setId("new-product-bttn");
